...
class _RegisterViewState extends State<RegisterView> {
  ...
  _bind() {
    ...
    _userNameTextEditingController.addListener(() {
      _registerViewModel.setUserName(_emailEditingController.text);
    });
...
/* _registerViewModel.isUserLoggedInSuccessfullyStreamController.stream.listen((isSuccessLoggedIn) { 
